...
class EmployeeStatusAdmin(admin.ModelAdmin):
    ...
    def status_type_display(self, obj):
        ...
        colors = {
            ...
            EmployeeStatus.StatusType.COMPETITION: 'teal',
            EmployeeStatus.StatusType.OTHER_ABSENCE: 'gray',
            EmployeeStatus.StatusType.ON_DUTY: 'darkgreen',
            EmployeeStatus.StatusType.AFTER_DUTY: 'lightgreen',
            EmployeeStatus.StatusType.CHILD_CARE: 'pink',
            EmployeeStatus.StatusType.ISOLATION: 'red',
            EmployeeStatus.StatusType.INTERNSHIP: 'darkblue',
            EmployeeStatus.StatusType.LEAVE_BY_REPORT: 'lightblue',
